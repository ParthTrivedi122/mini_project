...
// disable the buttoms
function disable() {
  binarySearchbtn2.setAttribute("disabled", true);
  linearSearchbtn2.setAttribute("disabled", true);
  searchbtn2.setAttribute("disabled", true);
  generateArraybtn2.setAttribute("disabled", true);
}
